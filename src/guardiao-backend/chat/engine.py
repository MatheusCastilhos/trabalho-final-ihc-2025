...
class ChatEngine:
    ...
    def _build_messages(self, new_user_message: str, history: List[Message]) -> List[Message]:
        """
        Monta a lista de mensagens no formato esperado.
        """
        messages: List[Message] = [
            {"role": "system", "content": self.system_prompt}
        ]

        # Adiciona histórico prévio (vindo do banco de dados)
    ...
    def send_message(self, user_input: str, history: List[Message]) -> str:
        """
        Recebe o texto do usuário e o histórico, envia para o modelo e devolve a resposta.
        NÃO atualiza mais o histórico interno.
        """
